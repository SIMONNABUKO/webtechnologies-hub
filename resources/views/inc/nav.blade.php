...
{{-- Stary of customized Navbar --}}
<div class="navbar navbar-expand-md navbar-dark bg-dark">
  <span class="navbar-text">learnCodeKE</span>
  <a href="#" class="navbar-brand">Webtechb</a>
<ul class="navbar-nav">
  <li class="nav-item">
    <a href="" class="nav-link">Udemy</a>
  </li>
  <li class="nav-item">
    <a href="" class="nav-link">code</a>
    </li>
  <li class="nav-item">
    <a href="" class="nav-link">tutsplus</a>
  </li>
  <li class="nav-item">
    <a href="" class="nav-link">lynda</a>
  </li>
...
<nav style="background-color:navy; color:white;" class="navbar navbar-expand-md navbar-default navbar-fixed-top navbar-laravel">
            <div class="container">
                <a style="color:#51d8af;" class="navbar-brand" href="{{ url('/') }}">
      ...
      <li class="nav-item">
        <a style="color:white; class="nav-link " href="/tutorials">e-Books</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a style="color:#51d8af;" class="nav-link" href="{{ route('login') }}">{{ __('Login') }}</a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a style="color:#51d8af;" class="nav-link" href="{{ route('register') }}">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
                            <li class="nav-item dropdown">
                                <a style="color:#51d8af; id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
